...
const AdminDashboard = () => {
  ...
  // Load users on component mount for overview statistics
  useEffect(() => {
    loadUsers();
  }, []);

  // Also load users when switching to users tab if not already loaded
  useEffect(() => {
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className=" btn btn-primary btn-sm flex  items-center bg-primary-600 hover:bg-primary-700 text-white py-2 px-2 md:px-4 rounded"
            >
              <Plus className="md:w-4 md:h-4 mr-1" />
              New Task
            </button>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
              ...
              <div className="flex space-x-4">
                <div className="flex flex-col relative items-center bg-blue-50 px-4 py-2 rounded-lg ml-auto">
                  <button className='ml-auto' onClick={() => setProfileButton(!profileButton)}>
                    <Bolt className={`h-6 w-6 text-purple-600 transition-transform ${profileButton ? "animate-spinClockwise" : "animate-spinAntiClockwise"
                      }`} />
                  </button>
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex flex-wrap gap-4 sm:space-x-8">
            <button
